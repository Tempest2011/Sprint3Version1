...
$cakeDescription = __d('cake_dev', 'Zeiko Technology');
   ...
   $database = mysql_select_db('vane',$con);
				...
				<div class="calendario" style="height:500px;"  style="height:500px;">
                                    ...
                                    <div>&nbsp;</div>
                                            ...
                                            <?php echo $this->Html->div('datepicker_img w100p fl pl460p pa', 
                                                             $this->Html->image('../app/webroot/img/calendar.gif'),array('id' => 'datepicker_img')); ?>
                                        ...
                                        <div class="enlace2">
                                                 <a href="../sprint1belen/full_calendar"> ver calendario completo</a></div>
